...
gem 'refinerycms-blog',              :git => 'git://github.com/blake0102/refinerycms-blog.git', :branch => 'adminredesign'
...
# END USER DEFINED
gem 'refinerycms-helpdocs', '1.0', :path => 'vendor/engines', :require => 'helpdocs'